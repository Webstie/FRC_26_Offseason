...
/**
 * Swerve drivetrain (AdvantageKit talonfx_swerve template, adapted to this 2026 project).
 *
 * <p>Real hardware runs through {@link ModuleIOTalonFX}/{@link GyroIOPigeon2} configured from {@link
...
public class Drive extends SubsystemBase {
  ...
  /** Advances the maple-sim physics world once per loop (only called in simulation). */
  @Override
